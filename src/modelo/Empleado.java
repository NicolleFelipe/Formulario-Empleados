...
public class Empleado extends Persona {
    ...
    try{
       ...
       cn.abrir_conexion();
       String query;
       query = "SELECT e.id_empleados as id ,e.codigo ,e.nombres ,e.apellidos ,e.direccion ,e.telefono ,e.fecha_nacimiento ,concat(p.id_puestos,') ',p.puesto) as puesto FROM  empleados as e inner join puestos as p on e.id_puesto = p.id_puestos ;";
